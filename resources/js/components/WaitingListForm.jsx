        ...
        >
                ...
                <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border ${
                        errors.name
                            ...
                            : "border-kunooz-border-subtle focus:ring-kunooz-primary-500/30"
            ...
            <div className="space-y-2">
                ...
                <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border border-kunooz-border-subtle focus:ring-kunooz-primary-500/30 focus:outline-none focus:ring-2 focus:border-transparent bg-white transition-all duration-200 ${
                        isRtl ? "text-right" : "text-left"
                    }`}
                    dir="ltr"
                />
